...
<body>
    <form id="form1" runat="server">
        <div>
            <h1>Orders Data:</h1>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="OrderId" DataSourceID="SqlDataSource1" GridLines="Horizontal" Height="442px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="732px">
